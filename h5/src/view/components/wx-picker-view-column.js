      ...
      if (touchInfo.trackingID != -1) {
        ...
        if (delta) {
          ...
          if (historyTimeLen > 2) {
            ...
            var lastHistoryTIme = touchInfo.historyTime[lastIdx]
            var lastHistoryX = touchInfo.historyX[lastIdx]
            var lastHistoryY = touchInfo.historyY[lastIdx]
            for (; lastIdx > 0;) {
              lastIdx--
              var timeItem = touchInfo.historyTime[lastIdx]
              var u = lastHistoryTIme - timeItem
              if (u > 30 && u < 50) {
