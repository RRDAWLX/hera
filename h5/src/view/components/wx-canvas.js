...
var format = function (obj, method, arr, key) {
          ...
          eventName === 'touchstart'
            ? changedTouches.forEach(function (curEvent) {
              ...
              (self._touchInfo[curEvent.identifier].timeStamp =
                    event.timeStamp),
              (self._touchInfo[curEvent.identifier].handler = setTimeout(
                function () {
          ...
          if (/^set/.test(_method)) {
            ...
            if (styleKey === 'fillStyle' || styleKey === 'strokeStyle') {
              if (_data[0] === 'normal') {
                ...
                var c = _data[1][2]
                var d = [s, l, 0, s, l, c]
                var _gradient = ctx.createRadialGradient.apply(ctx, d)
                _data[2].forEach(function (arr) {
                  var t = arr[0]
                  var n = resolveColor(arr[1])
                  _gradient.addColorStop(t, n)
            ...
            if (_method === 'fillPath' || _method === 'strokePath') {
              ...
              if (_method === 'fillText') {
                ...
                if (_method === 'drawImage') {
                  ...
                  var _url = transformUrl(_arr[0])
                  var params = _arr.slice(1)
